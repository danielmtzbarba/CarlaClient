...
def run_simulation(args, client):
    ...
    try:
        ...
        SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=0, z=15), carla.Rotation(yaw=+00, pitch=-90)), 
                   vehicle, {}, display_pos=[0, 1])
        SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=0, z=2.4)), 
                     vehicle, {'channels' : '64', 'range' : '100',  'points_per_second': '250000',
                                'rotation_frequency': '20'}, display_pos=[1, 0])
        SensorManager(world, display_manager, 'SemCamera', carla.Transform(carla.Location(x=0, z=13), carla.Rotation(yaw=+00, pitch=-90)), 
